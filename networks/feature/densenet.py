...
class _Transition(nn.Sequential):
    def __init__(self, num_input_features: int, num_output_features: int, stride: int=2) -> None:
        super().__init__()
    ...
    def __init__(
        ...
        for i, num_layers in enumerate(block_config):
            ...
            if i != len(block_config) - 1:
                trans = _Transition(num_input_features=num_features, num_output_features=num_features // 2, stride=transition_strides[i])
