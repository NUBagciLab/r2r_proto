...
from typing import Any, Callable, List, Optional, Sequence, Tuple, Union, TypeVar, Dict, Mapping
...
from networks.feature import _IMAGENET_CATEGORIES
...
def maxvit_t(**kwargs) -> MaxVit:
    ...
    .. autoclass:: torchvision.models.MaxVit_T_Weights
        :members:
    """
    weights = MaxVit_T_Weights.verify(MaxVit_T_Weights.IMAGENET1K_V1)
